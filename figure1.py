# -*- coding: utf-8 -*-
"""
Created on Mon Oct  4 08:59:41 2021
...
def figure1(latitude, longitude,
                                     racking,
                                     surface_tilt, 
                                     surface_azimuth,
                                     axis_tilt, 
    ...
    info = {'Source': 'PVGIS', 
       ...
       'timedelta_in_years': timedelta_in_year, 
       'Version': 'nann'
       }
    
    voc_hist_x, voc_hist_y = vocmax.make_voc_histogram(dffinal,info)
